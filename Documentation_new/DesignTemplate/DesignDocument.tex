...
\title{{\color{SDColor3} \rule{\linewidth}{0.5mm}}\\[2mm] {\huge \bfseries \color{SDColor3} Dahl Virtual Museum }\\[-1mm] {\color{SDColor3}\rule{\linewidth}{0.5mm}} \\  \vfill
{\LARGE \bfseries \color{SDColor4} Senior Design Final Documentation }\\  \vfill 
{\color{SDColor3} Dahl Arts Center} }
\author{\color{SDColor3}  Mackenzie Smith \and \color{SDColor3} Alex Nienhueser  }
