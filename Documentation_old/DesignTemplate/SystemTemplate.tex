...
\title{{\color{MSBlue1} \rule{\linewidth}{0.5mm}}\\[2mm] {\huge \bfseries \color{MSBlue1} Dahl Virtual Museum }\\[-1mm] {\color{MSBlue1}\rule{\linewidth}{0.5mm}} \\  \vfill
{\LARGE \bfseries \color{MSBlue2} Senior Design Final Documentation }\\  \vfill 
{\color{MSBlue1} Virtual Museum} }
\author{\color{MSBlue1}  Mackenzie Smith \and \color{MSBlue1} Alex Nienhueser \and  \color{MSBlue1}}
...
\includepdf[pages={1-4}]{Contract/DahlContract.pdf}
